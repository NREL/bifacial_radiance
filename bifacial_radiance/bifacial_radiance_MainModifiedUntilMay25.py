...
if __name__ == "__main__":
    ...
    demo.setGround(0.23) # solarworld Grass Meadow albedo. input albedo number or material name like 'concrete'.  To see options, run this without any input.
    try:
        epwfile = demo.getEPW(42.22, -121.74) # pull TMY data for any global lat/lon
    except:
        pass
    ...
    sceneDict = {'tilt':10,'pitch':4.24285,'height':1.485,'orientation':'landscape','azimuth':180}  
